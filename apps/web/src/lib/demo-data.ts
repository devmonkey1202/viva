...
export const demoVerificationInput: GenerateQuestionSetRequest = {
  ...
  assignmentDescription:
    "학생은 자유낙하 실험 결과를 바탕으로 중력가속도와 오차 원인을 설명해야 합니다.",
  rubricCoreConcepts: [
    "중력가속도",
    "자유낙하",
    "오차 원인",
  ...
  submissionText:
    "실험 결과를 보면 물체가 낙하할수록 속도가 빨라지므로 가속도가 커진다고 보고 있다. 여러 번의 측정에서 비슷한 값을 얻었고 이론값과 차이가 있었지만 이는 주로 센서 반응 속도와 공기 저항 때문이라고 정리했다. 중력가속도는 물체가 떨어지는 위치에 따라 달라진다고 설명했다.",
  sessionPreferences: {
...
export const demoAnswerDraft = {
  why: "센서 반응 속도가 느리면 실제 시간보다 길게 측정될 수 있어 오차 원인으로 볼 수 있습니다.",
  transfer:
    "만약 진공 상태라면 공기 저항이 줄어들어 이론값에 더 가까워질 것 같습니다.",
  counterexample:
    "낙하 시간이 짧아질수록 가속도가 커진다고 보는 것은 아니고, 같은 중력장에서는 가속도 자체는 거의 일정합니다.",
};
